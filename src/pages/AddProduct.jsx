...
const AddProduct = () => {
  return (
    <div className='w-10/12 flex gap-6 p-10 ml-[17%] flex-col items-start'>
      ...
      <div>
        <label htmlFor="department" className='flex gap-4 items-center justify-center'>
          <span>Department</span>
          <select name="department" id="department" className='bg-gray-200 p-2 rounded-lg'>
      ...
      <div>
        <button className='bg-blue-500 rounded-lg px-6 py-3 text-white'>Add Product</button>
      </div>
    </div>
  )
}
